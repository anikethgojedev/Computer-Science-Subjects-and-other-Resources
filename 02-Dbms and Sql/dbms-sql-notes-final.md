...
**Database Basics**
- [Database Basics — Part 1](#toc1)
- [What is a Database?](#toc2)
- [What is a DBMS?](#toc3)
- [Why do we need a DBMS?](#toc4)
- [What is an RDBMS?](#toc5)
- [What exactly is SQL?](#toc6)
- [What is a table?](#toc7)
- [CRUD](#toc8)

**Keys, Relationships & Normalization**
- [Database Basics — Part 2 (Keys & Relationships)](#toc9)
- [Primary Key](#toc10)
- [Foreign Key](#toc11)
- [Relationships (1:1, 1:N, N:N)](#toc12)
- [Normalization](#toc13)

**Constraints + NULL**
- [Constraints + Keys + NULL in MySQL](#toc14)
- [NOT NULL](#toc15)
- [UNIQUE](#toc16)
- [PRIMARY KEY (constraint)](#toc17)
- [DEFAULT](#toc18)
- [CHECK](#toc19)
- [FOREIGN KEY (constraint)](#toc20)
- [ON DELETE CASCADE](#toc21)

**SELECT / WHERE**
- [SELECT Starts Now](#toc22)
- [Comparison Operators](#toc23)
- [AND / OR / NOT](#toc24)
- [NULL in WHERE](#toc25)

**Filtering: DISTINCT, LIKE, IN, BETWEEN**
- [Filtering Like an Interviewer](#toc26)
- [DISTINCT](#toc27)
- [LIKE](#toc28)
- [IN](#toc29)
- [BETWEEN](#toc30)

**ORDER BY / LIMIT / Aggregation**
- [ORDER BY](#toc31)
- [NULL and ORDER BY](#toc32)
- [LIMIT](#toc33)
- [Aggregate Functions & GROUP BY](#toc34)
- [HAVING](#toc35)

**JOINs**
- [JOINs — Why They Exist](#toc36)
- [SELF JOIN](#toc37)

**Subqueries & Advanced Filtering**
- [WHERE vs HAVING / Subqueries](#toc38)
- [EXISTS vs IN vs JOIN vs NOT EXISTS vs LEFT JOIN ... IS NULL](#toc39)
- [Advanced GROUP BY + Aggregation Patterns](#toc40)

**DDL / DML / DCL / TCL**
- [DDL — CREATE / ALTER / DROP / TRUNCATE](#toc41)
- [DML — INSERT, UPDATE, DELETE](#toc42)
- [DCL — Data Control Language](#toc43)
- [TCL — Transactions](#toc44)

**Set Operations, Subqueries II, Views, Indexes**
- [Set Operations (UNION, INTERSECT, EXCEPT)](#toc45)
- [Subqueries — WHERE / FROM / HAVING](#toc46)
- [MySQL Views](#toc47)
- [Indexes](#toc48)
